/**
 * Utilitário compartilhado para normalização de questões do ENEM.
 * Contém: ENUNCIADOS_PROTEGIDOS, mapDiscipline(), normalizeQuestion()
 * Usado por: src/services/enemApiService.js e scripts/preload-questions.js
 */
...
module.exports = { ENUNCIADOS_PROTEGIDOS, mapDiscipline, normalizeQuestion };
