...
const ENUNCIADOS_PROTEGIDOS = {
  ...
  "2021-91-natureza": `No cultivo por hidroponia, são utilizados soluções nutritivas contendo macronutrientes e micronutrientes essenciais. Além dos nutrientes, o pH é um parâmetro de extrema importância, uma vez que ele afeta a preparação da solução nutritiva e a absorção dos nutrientes pelas plantas. Para o cultivo de alface, os valores de pH da solução nutritiva devem estar entre 5,5 e 6,5. Para o ajuste do pH, um produtor de alfaces hidropônicas pode utilizar as seguintes soluções aquosas: hidróxido de potássio (KOH), sulfato de potássio (K2SO4) ou ácido sulfúrico (H2SO4). Das soluções listadas, quais podem ser empregadas pelo produtor para ajustar o pH da solução nutritiva?`,
  "2021-95-natureza": `Os pesticidas organoclorados foram amplamente empregados na agricultura, contudo, em razão das suas elevadas toxicidades e persistências no meio ambiente, eles foram banidos. Considere que, em uma análise para determinar a presença de um pesticida organoclorado em um rio, 100 mL de água foram extraídos com 10 mL de hexano. Sabendo-se que o pesticida X (massa molar = 300 g/mol) apresenta um coeficiente de partição octanol-água (Kow) de 10^5, qual a concentração, em mol/L, do pesticida na fase orgânica?`,
  "2021-101-natureza": `A obtenção de etanol utilizando a cana-de-açúcar envolve a fermentação dos monossacarídeos formadores da sacarose, contida no melaço. Um desses formadores é a glicose (C6H12O6), cuja fermentação produz cerca de 50 g de etanol (C2H5OH) a partir de 100 g de glicose, conforme a equação química descrita. Em uma condição específica de fermentação, obtém-se 80% de conversão em etanol que, após sua purificação, apresenta densidade igual a 0,80 g/mL. O melaço utilizado apresentou 50 kg de monossacarídeos na forma de glicose. Qual o volume de etanol, em litro, obtido nesse processo?`,
  "2021-102-natureza": `É possível ligar aparelhos elétricos de baixa corrente utilizando materiais comuns de laboratório no lugar das tradicionais pilhas. A ilustração apresenta uma montagem que faz funcionar um cronômetro digital. Utilizando a mesma montagem, pode-se ligar um LED, que requer uma tensão de pelo menos 2,0 V para acender. Qual modificação deve ser feita no sistema para que o LED acenda?`,
  "2021-104-natureza": `O rompimento da barragem de rejeitos de mineração no município mineiro de Mariana e o derramamento de produtos tóxicos nas águas do Rio Doce, ocorridos em 2015, ainda têm consequências para os organismos que habitam a bacia hidrográfica, como os peixes. A toxicidade desses produtos pode ser avaliada por meio de testes de letalidade, em que diferentes doses são testadas. Os resultados são expressos em CL50-96h, que corresponde à concentração letal para 50% dos organismos em 96 horas de exposição. Qual o procedimento experimental que permite determinar a CL50-96h de um composto?`,
  "2015-147-matematica": `Uma empresa de telefonia oferece um plano em que o cliente paga um valor fixo mensal de R$ 35,00 por até 100 minutos de ligações locais. Caso o cliente exceda essa franquia, será cobrado um valor adicional de R$ 0,50 por minuto excedente. Com base nos elementos apresentados, o gráfico que melhor representa a relação entre o valor mensal pago nesse plano e o número de ligações feitas é:`,
};
